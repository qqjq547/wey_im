 ...
 *
 * PreviewPrivateBridgeActivity
 */
@Route(path = Constant.ARouter.ROUNTE_MSG_PREVIEW_BRIDGE_ACTIVITY)
class PreviewBridgeActivity:BaseActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ARouter.getInstance().build(Constant.ARouter.ROUNTE_MSG_PREVIEW_ACTIVITY)
                .withLong("messageLocalId", mMessageLocalId)
                .withInt("chatType", mChatType)
                .withLong("targetId", mTargetId)
                .withBoolean("shouldReverse", mShouldReverse)
