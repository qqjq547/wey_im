 ...
 * </pre>
 */
package framework.telegram.message.ui.widget.ratioview;
 ...
 */
public class RatioAbsoluteLayout extends AbsoluteLayout implements RatioMeasureDelegate {
    ...
    public RatioAbsoluteLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRatioLayoutDelegate = RatioLayoutDelegate.obtain(this, attrs);
    }

    public RatioAbsoluteLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mRatioLayoutDelegate = RatioLayoutDelegate.obtain(this, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RatioAbsoluteLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (mRatioLayoutDelegate != null && getVisibility() != GONE) {
