...
@Route(path = Constant.ARouter.ROUNTE_MSG_STREAM_CALL_HISTORY_FRAGMENT_UNCALL)
class StreamCallHistoryUncallFragment : BaseFragment(), StreamCallContract.View, IMultiCheckCallCallback {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.msg_fragment_stream_call_history_uncall, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        EventBus.getFlowable(JumpStreamTopEvent::class.java)//跳转到顶部
                .bindToLifecycle(this@StreamCallHistoryUncallFragment)
        ...
        mPresenter?.getStreamUnCallHistoryData()
    }
        ...
        mAdapter.setOnItemClickListener { _, _, position ->
            if (!mAdapter.isMultiCheckMode) {
                if (NetworkUtils.isAvailable(BaseApp.app) && ReceiveMessageManager.socketIsLogin) {
                    ...
                    data?.let {
                        activity?.let {
                            AppDialog.showList(it, this@StreamCallHistoryUncallFragment,
    ...
    override fun clickBatchDelete() {
        ...
        AppDialog.show(activity!!, this@StreamCallHistoryUncallFragment) {
