...
public class RadioGroupView extends LinearLayout {
    ...
    public RadioGroupView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RadioGroupView.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RadioGroupView.LayoutParams;
    }
    ...
    public CharSequence getAccessibilityClassName() {
        return RadioGroupView.class.getName();
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RadioGroupView group, int checkedId);
    }
