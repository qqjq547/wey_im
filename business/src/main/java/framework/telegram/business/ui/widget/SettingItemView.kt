 ...
 */
class SettingItemView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    fun setDataBottomValue(value: String) {
        app_text_view_bottom_value.text = value
    }

    fun setDataBottomValueVisible(visible: Boolean) {
        app_text_view_bottom_value.visibility = if (visible) View.VISIBLE else View.GONE
    }
