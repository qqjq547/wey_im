...
class OperateContactItemAdapter(private val listen: ((Int) -> Unit)) : AppBaseQuickAdapter<OperateContactActivity.SelectUser, BaseViewHolder>(R.layout.bus_group_item_create_select) {
