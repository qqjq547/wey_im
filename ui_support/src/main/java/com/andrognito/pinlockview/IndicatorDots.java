...
public class IndicatorDots extends LinearLayout {
    ...
    private int mFillErrorDrawable;
    ...
    public IndicatorDots(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mFillErrorDrawable = typedArray.getResourceId(R.styleable.PinLockView_dotFilledErrorBackground,
                    R.drawable.dot_filled_red);
    ...
    public void setDotErrorStyle() {
        for (int i = 0; i < getChildCount(); i++) {
            fillRedDot(getChildAt(i));
        }
    }

    public void setDotEmptyStyle() {
        for (int i = 0; i < getChildCount(); i++) {
    ...
    private void fillRedDot(View dot) {
        dot.setBackgroundResource(mFillErrorDrawable);
    }
