...
public class PinLockView extends RecyclerView {
    ...
    private void init(AttributeSet attributeSet, int defStyle) {
        ...
        try {
            ...
            mTextColor = typedArray.getColor(R.styleable.PinLockView_keypadTextColor, ResourceUtils.getColor(getContext(), R.color.black));
    ...
    public void startDotErrorStyle() {
        if (mIndicatorDots != null) {
            mIndicatorDots.setDotErrorStyle();

            postDelayed(() -> {
                mIndicatorDots.setDotEmptyStyle();
                resetPinLockView();
            }, 800);
        }
    }
