...
public class GestureDrawLine extends View {
    ...
    public GestureDrawLine(Context context, List<GesturePoint> list, boolean isVerify,
                           String passWord, long errorMaxTime, GestureCallBack callBack,
        ...
        this.selectedColor = data.getLineColor();
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:// 当手指抬起的时候
                if (isVerify) {
                    ...
                    long pastTime = System.currentTimeMillis() - errorMaxTime;
                    if (pastTime < GestureUnlock.UNLOCK_ERROR_WAIT_TIME) {
                        callBack.checkedErrorMax(pastTime);
                    } else {
    ...
    public interface GestureCallBack {
        ...
        void checkedErrorMax(long pastTime);
    }
}
