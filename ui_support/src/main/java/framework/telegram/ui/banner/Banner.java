package framework.telegram.ui.banner;
...
import framework.telegram.ui.banner.listener.OnBannerClickListener;
import framework.telegram.ui.banner.listener.OnBannerListener;
import framework.telegram.ui.banner.loader.ImageLoaderInterface;
import framework.telegram.ui.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void setImageUrl(int position){
        ...
        if (imageLoader != null){
            imageLoader.displayImage(context, url, imageViews.get(position),position);
        }
        else
