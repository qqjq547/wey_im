...
import framework.telegram.ui.qr.camera.BitmapLuminanceSource;
import framework.telegram.ui.qr.camera.CameraManager;
import framework.telegram.ui.qr.decoding.DecodeFormatManager;
...
//            decodeFormats.addAll(DecodeFormatManager.DATA_MATRIX_FORMATS);
        ...
        if (rawResult != null) {
            if (analyzeCallback != null) {
                analyzeCallback.onAnalyzeSuccess( rawResult.getText());
            }
        } else {
            if (analyzeCallback != null) {
