...
import framework.telegram.ui.cameraview.utils.Task;
...
public abstract class CameraController implements
    ...
    // Used for testing.
    Task<Integer> mZoomTask = new Task<>();
    Task<Integer> mExposureCorrectionTask = new Task<>();
    Task<Integer> mFlashTask = new Task<>();
    Task<Integer> mWhiteBalanceTask = new Task<>();
    Task<Integer> mHdrTask = new Task<>();
    Task<Integer> mLocationTask = new Task<>();
    Task<Integer> mStartVideoTask = new Task<>();
    Task<Integer> mPlaySoundsTask = new Task<>();
