...
import framework.telegram.ui.cameraview.options.Audio;
import framework.telegram.ui.cameraview.options.Control;
import framework.telegram.ui.cameraview.options.Facing;
import framework.telegram.ui.cameraview.options.Flash;
import framework.telegram.ui.cameraview.options.Gesture;
import framework.telegram.ui.cameraview.options.GestureAction;
import framework.telegram.ui.cameraview.options.Grid;
import framework.telegram.ui.cameraview.options.Hdr;
import framework.telegram.ui.cameraview.options.Mode;
import framework.telegram.ui.cameraview.options.Preview;
import framework.telegram.ui.cameraview.options.VideoCodec;
import framework.telegram.ui.cameraview.options.WhiteBalance;
import framework.telegram.ui.cameraview.utils.CameraLogger;
import framework.telegram.ui.cameraview.utils.CropHelper;
import framework.telegram.ui.cameraview.utils.OrientationHelper;
import framework.telegram.ui.cameraview.utils.SizeSelectors;
import framework.telegram.ui.cameraview.utils.WorkerHandler;
import framework.telegram.ui.cameraview.views.CameraPreview;
import framework.telegram.ui.cameraview.views.GestureLayout;
import framework.telegram.ui.cameraview.views.GlCameraPreview;
import framework.telegram.ui.cameraview.views.GridLinesLayout;
import framework.telegram.ui.cameraview.views.PinchGestureLayout;
import framework.telegram.ui.cameraview.views.ScrollGestureLayout;
import framework.telegram.ui.cameraview.views.SurfaceCameraPreview;
import framework.telegram.ui.cameraview.views.TapGestureLayout;
import framework.telegram.ui.cameraview.views.TextureCameraPreview;
