...
import framework.telegram.ui.cameraview.utils.FileCallback;
...
public class PictureResult {
    ...
    /**
     * Shorthand for {@link CameraUtils#writeToJpgFile(byte[], File, FileCallback)}.
     ...
     */
    public void toJpgFile(@NonNull File file, @NonNull FileCallback callback) {
        CameraUtils.writeToJpgFile(getData(), file, callback);
    }
}
