...
public class CheckView extends View {
    ...
    private static final float SHADOW_WIDTH = 3.0f; // dp
    ...
    private void init(Context context) {
        ...
        int defaultColor = ResourcesCompat.getColor(
                getResources(), R.color.ordinary_item_checkCircle_borderColor,
                getContext().getTheme());
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), R.color.ordinary_item_checkCircle_backgroundColor,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
