...
import framework.telegram.ui.imagepicker.internal.entity.CaptureStrategy;
...
public final class SelectionCreator {
     ...
     * 1. R.style.ImagePicker_Ordinary;
     * 2. R.style.ImagePicker_Night
     * you can define a custom theme derived from the above ones or other themes.
     *
     * @param themeId theme resource id. Default value is R.style.ImagePicker_Ordinary.
     * @return {@link SelectionCreator} for fluent API.
     */
     ...
     * <p>
     * It's a redundant API with {@link ImagePicker#obtainResult(Intent)},
