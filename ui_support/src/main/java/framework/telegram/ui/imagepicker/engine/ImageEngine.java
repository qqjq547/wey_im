package framework.telegram.ui.imagepicker.engine;
...
public interface ImageEngine {
     ...
     * @param uri         Uri of the loaded image
     */
    void loadThumbnail(Context context, int resize, Drawable placeholder, SubsamplingScaleImageView imageView, Uri uri);
     ...
     * @param uri         Uri of the loaded image
     */
    void loadGifThumbnail(Context context, int resize, Drawable placeholder, SubsamplingScaleImageView imageView, Uri uri);
     ...
     * @param uri       Uri of the loaded image
     */
    void loadImage(Context context, int resizeX, int resizeY, SubsamplingScaleImageView imageView, Uri uri);
     ...
     * @param uri       Uri of the loaded image
     */
    void loadGifImage(Context context, int resizeX, int resizeY, SubsamplingScaleImageView imageView, Uri uri);
