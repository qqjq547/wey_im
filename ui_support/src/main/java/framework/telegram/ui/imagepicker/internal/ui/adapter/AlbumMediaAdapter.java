...
import framework.telegram.ui.imagepicker.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    private boolean mChooseMultiple;

    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedCollection, RecyclerView recyclerView, boolean chooseMultiple) {
        super(null);
        ...
        mChooseMultiple = chooseMultiple;
    }
