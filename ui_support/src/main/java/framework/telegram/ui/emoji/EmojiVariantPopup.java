...
public final class EmojiVariantPopup {
    ...
    private View initView(@NonNull final Context context, @NonNull final Emoji emoji, final int width) {
        final View result = View.inflate(context, R.layout.msg_emoji_popup_window_skin, null);
        ...
        for (final Emoji variant : variants) {
            final ImageView emojiImage = (ImageView) inflater.inflate(R.layout.msg_emoji_adapter_item, imageContainer, false);
