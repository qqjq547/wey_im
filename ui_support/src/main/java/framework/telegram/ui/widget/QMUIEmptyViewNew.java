...
public class QMUIEmptyViewNew extends FrameLayout {
    ...
    public QMUIEmptyViewNew(Context context) {
        this(context,null);
    }

    public QMUIEmptyViewNew(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public QMUIEmptyViewNew(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.qmui_empty_view_new, this, true);
        ...
        mImageView = (ImageView)findViewById(R.id.empty_view_image);
        mButton = (Button)findViewById(R.id.empty_view_button);
        mTopTextView = (TextView)findViewById(R.id.empty_view_title_2);
    }
    ...
    public void setImageView(int rid){
        if (rid != 0)
            mImageView.setBackground(ContextCompat.getDrawable(this.getContext(), rid));
        mImageView.setVisibility(rid != 0 ? VISIBLE : GONE);
    }
    ...
    public void setTopText(String text) {
        ...
        mTopTextView.setVisibility(text != null ? VISIBLE : GONE);
    }
