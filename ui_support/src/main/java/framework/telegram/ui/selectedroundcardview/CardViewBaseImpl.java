...
class CardViewBaseImpl implements CardViewImpl {
    ...
    public void initStatic() {
        ...
        RoundRectDrawableWithShadow.sRoundRectHelper =
                (canvas, bounds, cornerRadius, paint) -> {
                    ...
                    RoundRectDrawable.drawTopRoundRect(canvas,mCornerRect, cornerRadius,cornerRadius,paint,roundedCorner);
    ...
    @Override
    public void initialize(CardViewDelegate cardView, Context context, ColorStateList backgroundColor, float radius, float elevation, float maxElevation, boolean[] roundedCorner) {
