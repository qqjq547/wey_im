...
/**
 * 状态栏透明和设置状态栏字体颜色
 * 对于小米手机，在android7.0+（好像是6.0+）后，其已经放弃自家的更改状态栏字体颜色api，用Google原生的api代替
 * 所以这里针对小米的代码应该是已失效的
 */
...
public class StatusBarUtil {
    ...
    /**
     * google在Android6.0之后，就可以修改状态栏颜色和状态栏字体颜色了
     * 但是在6.0之前，小米和魅族开发了自己的api。用于修改状态栏颜色
     * 这个和6.0是冲突了，后来小米和魅族好像又取消了他们的api，统一使用6.0的api
     * 所以对于6.0，只用原生的就够了
     * @param activity
     */
    public static void justMDarkMode(Activity activity) {
