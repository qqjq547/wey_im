...
import static framework.telegram.support.system.log.core.utils.FileUtils.ZIP_EXT;
...
public final class LogUtils {
    ...
    public static void zipLogs(@NonNull File file) throws IOException {
        ...
        String destPath = filePath.substring(0, index) + FileUtils.ZIP_EXT;
    ...
    private static String genInfo(@NonNull Context context) {
        ...
        String info = "";
        info += "app version name : " + SysUtils.getAppVersionName(
                context) + lineSeparator;
        info += "app version code : " + SysUtils.getAppVersionCode(
                context) + lineSeparator;
        info += "os version name : " + SysUtils.getOsVersionName()
                + lineSeparator;
        info += "os version code : " + SysUtils.getOsVersionCode()
                + lineSeparator;
        info += "os display name : "
                + SysUtils.getOsVersionDisplayName() + lineSeparator;
        info += "brand info : " + SysUtils.getBrandInfo()
                + lineSeparator;
        info += "product info : " + SysUtils.getProductInfo()
                + lineSeparator;
        info += "model info : " + SysUtils.getModelInfo()
                + lineSeparator;
