...
import framework.telegram.support.commandrouter.annotation.DefaultHandler;
...
import framework.telegram.support.commandrouter.converter.ValueConverterException;
import framework.telegram.support.commandrouter.driver.AbstractDriver;
import framework.telegram.support.commandrouter.driver.DriverException;
...
public final class CommandRouter {
    ...
    public boolean executeCommand(Object context, Object... args) {
        Op op;
        try {
        ...
        try {
            return handler.executeCommand(this, op);
