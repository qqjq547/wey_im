...
/**
 * Maintains a pool of active SQLite org.sqlite.database connections.
 * <p>
...
public final class SQLiteConnectionPool implements Closeable {
     ...
     * operations to be serialized by locking the primary org.sqlite.database connection.
     ...
     * of the org.sqlite.database connection request.
     * </p>
     */
    ...
    /**
     * Opens a connection pool for the specified org.sqlite.database.
     *
     * @param configuration The org.sqlite.database configuration.
     * @return The connection pool.
     *
     * @throws SQLiteException if a org.sqlite.database error occurs.
     */
    ...
    private void open() {
        ...
        // This might throw if the org.sqlite.database is corrupt.
    ...
    /**
     * Reconfigures the org.sqlite.database configuration of the connection pool and all of its
     * connections.
     * <p>
    ...
    public void reconfigure(SQLiteDatabaseConfiguration configuration) {
        ...
        synchronized (mLock) {
            ...
            if (walModeChanged) {
                ...
                if (!mAcquiredConnections.isEmpty()) {
                    throw new IllegalStateException("Write Ahead Logging (WAL) mode cannot "
                            ...
                            + "org.sqlite.database connections first.");
                }
            ...
            if (mConfiguration.openFlags != configuration.openFlags) {
                ...
                // This might throw if the org.sqlite.database is corrupt or cannot be opened in
                ...
                // Reconfigure the org.sqlite.database connections in place.
                mConfiguration.updateParametersFrom(configuration);
                setMaxConnectionPoolSizeLocked();
     ...
     * contention over available org.sqlite.database connections.
     *
    ...
    void onConnectionLeaked() {
        ...
        Log.w(TAG, "A SQLiteConnection object for org.sqlite.database '"
                + mConfiguration.label + "' was leaked!  Please fix your application "
                + "to end transactions in progress properly and to close the org.sqlite.database "
    ...
    private void logConnectionPoolBusyLocked(long waitMillis, int connectionFlags) {
        ...
        msg.append("The connection pool for org.sqlite.database '").append(mConfiguration.label);
	...
	if( !mAcquiredConnections.isEmpty() || mAvailablePrimaryConnection==null ) {
	  throw new IllegalStateException(
	      "Cannot enable localized collators while org.sqlite.database is in use"
	  );
	}
