...
/**
 * Describes how to configure a org.sqlite.database.
 * <p>
 * The purpose of this object is to keep track of all of the little
 * configuration settings that are applied to a org.sqlite.database after it
...
public final class SQLiteDatabaseConfiguration {
    // The pattern we use to strip email addresses from org.sqlite.database paths
    ...
    /**
     * The org.sqlite.database path.
     */
    public final String path;

    /**
     * The label to use to describe the org.sqlite.database when it appears in logs.
     * This is derived from the path but is stripped to remove PII.
     */
    public final String label;

    /**
     * The flags used to open the org.sqlite.database.
     */
    public int openFlags;

    /**
     * The maximum size of the prepared statement cache for each org.sqlite.database connection.
    ...
    /**
     * The org.sqlite.database locale.
     *
    ...
    /**
     * Creates a org.sqlite.database configuration with the required parameters for opening a
     * org.sqlite.database and default values for all other parameters.
     *
     * @param path The org.sqlite.database path.
     * @param openFlags Open flags for the org.sqlite.database, such as {@link SQLiteDatabase#OPEN_READWRITE}.
     */
    ...
    /**
     * Creates a org.sqlite.database configuration as a copy of another configuration.
     *
    ...
    /**
     * Returns true if the org.sqlite.database is in-memory.
