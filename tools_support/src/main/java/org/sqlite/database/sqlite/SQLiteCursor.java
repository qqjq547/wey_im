...
public class SQLiteCursor extends AbstractWindowedCursor {
    ...
    /**
     * Get the org.sqlite.database that this cursor is associated with.
    ...
    ** closeWindow(), which are used by the android.org.sqlite.database.sqlite.* version of this
            ...
            if (mWindow != null) {
                ...
                if (mStackTrace != null) {
                    ...
                    StrictMode.onSqliteObjectLeaked(
                        ...
                        "org.sqlite.database = " + mQuery.getDatabase().getLabel() +
                        ", table = " + mEditTable +
